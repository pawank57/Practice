...
//	}
	...
	public void m7() {
		System.out.println("Child class incresed access modifier scope method."); // Scope of modifier can me increased
																					// but not decreased.
	}
...
public class Program {
	public static void main(String[] args) {
		...
		a.m8(10); // not method overriding, hence method resolution taken care by compiler based
					// on reference type.
		b.m8(10);
		a1.m8(10);
